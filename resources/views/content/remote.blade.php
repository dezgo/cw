...
@section('head')
<title>Remote IT Support Canberra | Phone Computer Support Canberra</title>
@stop
...
<div class="row">
    ...
    <div class="col-md-7">
        ...
        eyes!<br>
        <br>
        <a class="remote_support" target="qs" href='http://get.teamviewer.com/computerwhiz_qs'><img alt="Get started" src="/images/btn_getstarted.png"></a>
